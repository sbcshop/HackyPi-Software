# This program demonstrate how HackyPi can open Youtube channel and subscribe to channel
# This code works for Windows based PC/Laptop but can be modified for Other OS
# For doing subscribe operation on youtube, You need to be login in your default browser with gmail
import time
import board
import usb_hid
import digitalio
...
try:
    ...
    time.sleep(0.3)
    keyboard_layout.write("start https://www.youtube.com/@SBComponentsLtd?sub_confirmation=1")
    keyboard.send(Keycode.ENTER)
    time.sleep(10)
